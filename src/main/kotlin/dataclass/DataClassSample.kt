...
fun main() {
  val data1 = NoDataClassSample(name = "simple", age = 10)
  val data2 = NoDataClassSample(name = "simple", age = 10)
  ...
  val data3 = DataClassSample(name = "simple", age = 10)
  val data4 = DataClassSample(name = "simple", age = 10)
  ...
  val data6 = data3.copy(name = "simple is the best")
